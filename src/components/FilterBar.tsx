  ...
  return (
    <div className="flex justify-end items-start sticky top-20 z-40 mb-10 px-0 pointer-events-none max-w-7xl mx-auto w-full">
      <div className="bg-[#01c573] rounded-xl shadow-md p-1.5 sm:p-2 w-full md:w-fit max-w-full flex flex-row items-center pointer-events-auto gap-1.5 sm:gap-2 md:gap-0 transition-all duration-500 ease-in-out">
        ...
        <div className={`flex flex-row items-center gap-1.5 sm:gap-2 flex-1 md:flex-none md:w-auto md:max-w-fit shrink-0 justify-end min-w-0`}>
          ...
          <div className="relative flex-1 min-w-0 md:w-80 md:flex-none">
            ...
            <input
              ...
              className="w-full pl-9 md:pl-11 pr-3 md:pr-4 h-10 bg-white/95 border-none shadow-sm rounded-lg text-[13px] md:text-[14px] font-medium text-gray-900 placeholder-gray-500 hover:bg-white focus:outline-none focus:ring-2 focus:ring-white/50 transition-all truncate"
              value={searchQuery}
              onChange={(e) => {
          ...
          <button
            ...
            className="flex items-center justify-center h-10 w-10 bg-black/10 hover:bg-black/20 text-white rounded-lg transition-colors shrink-0 tooltip-trigger relative group"
            aria-label="重置筛选"
          >
